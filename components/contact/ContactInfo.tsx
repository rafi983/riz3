...
const contactInfo = [
  {
    ...
    command: "mail -s 'Hello' rafiirfan211@gmail.com",
    status: "online",
  },
  {
    icon: FaMapMarkerAlt,
  ...
  },
  {
    ...
    command: "git clone https://github.com/rafi983",
    status: "active",
  },
  {
    icon: FaLinkedin,
    title: "linkedin",
    value: "@rafi-irfan-zaman",
    href: "https://www.linkedin.com/in/rafi-irfan-zaman/",
    command: "curl -L linkedin.com/in/rafi-irfan-zaman",
    status: "professional",
  },
];
